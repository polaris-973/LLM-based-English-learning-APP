...
// 使用CORS代理
const API_BASE_URL = "https://cors-anywhere.herokuapp.com/https://dashscope.aliyuncs.com/compatible-mode/v1";
...
export const generateMultipleChoiceQuestions = async (knowledgePoint, count = 5) => {
  try {
    ...
    console.log("正在调用API生成选择题...", window.location.origin);
